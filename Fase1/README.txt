...
MequieServer
java -Djava.security.manager -Djava.security.policy=MequieServer.policy MequieServer <porto>

Mequie
java -Djava.security.manager -Djava.security.policy=Mequie.policy Mequie <ip:porto> <localUserID> <password>
